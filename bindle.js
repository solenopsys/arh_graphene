...
var generateVertexExtensions = function(parameters) {
  const chunks = [
...
class t {
  ...
  _callOnChange() {
    this.parent._callOnChange(this), this._onChange !== undefined && this._onChange.call(this, this.getValue()), this._changed = true;
  }
  onFinishChange(t2) {
    return this._onFinishChange = t2, this;
  }
  _callOnFinishChange() {
    this._changed && (this.parent._callOnFinishChange(this), this._onFinishChange !== undefined && this._onFinishChange.call(this, this.getValue())), this._changed = false;
  }
  reset() {
  ...
  options(t2) {
    const i = this.parent.add(this.object, this.property, t2);
  ...
  listen(t2 = true) {
    return this._listening = t2, this._listenCallbackID !== undefined && (cancelAnimationFrame(this._listenCallbackID), this._listenCallbackID = undefined), this._listening && this._listenCallback(), this;
  }
  _listenCallback() {
...
class d extends t {
  ...
  updateDisplay() {
    ...
    return this._inputFocused || (this.$input.value = this._decimals === undefined ? t2 : t2.toFixed(this._decimals)), this;
  }
  _initInput() {
  ...
  _getImplicitStep() {
    return this._hasMin && this._hasMax ? (this._max - this._min) / 1000 : 0.1;
  }
  _onUpdateMinMax() {
...
class g {
  constructor({ parent: t2, autoPlace: i2 = t2 === undefined, container: e2, width: s2, title: n2 = "Controls", injectStyles: l2 = true, touchStyles: r2 = true } = {}) {
  ...
  _callOnChange(t2) {
    this.parent && this.parent._callOnChange(t2), this._onChange !== undefined && this._onChange.call(this, { object: t2.object, property: t2.property, value: t2.getValue(), controller: t2 });
  }
  onFinishChange(t2) {
    return this._onFinishChange = t2, this;
  }
  _callOnFinishChange(t2) {
    this.parent && this.parent._callOnFinishChange(t2), this._onFinishChange !== undefined && this._onFinishChange.call(this, { object: t2.object, property: t2.property, value: t2.getValue(), controller: t2 });
  }
  destroy() {
...
class Water extends Mesh {
  constructor(geometry, options = {}) {
    ...
    const sunDirection = options.sunDirection !== undefined ? options.sunDirection : new Vector3(0.70707, 0.70707, 0);
    const sunColor = new Color(options.sunColor !== undefined ? options.sunColor : 16777215);
    const waterColor = new Color(options.waterColor !== undefined ? options.waterColor : 8355711);
...
function createTorusGeometry(innerRadius, outerRadius, radialSegments, tubularSegments) {
  ...
  for (let j = 0;j <= tubularSegments; j++) {
    for (let i2 = 0;i2 <= radialSegments; i2++) {
      const theta = i2 / radialSegments * Math.PI * 2;
      ...
      vertices.push(x, y, z);
      if (i2 < radialSegments && j < tubularSegments) {
        const first = i2 + (radialSegments + 1) * j;
        const second = i2 + (radialSegments + 1) * (j + 1);
...
var blueMaterial = new MeshStandardMaterial({ roughness: 0.25 });
redMaterial.color.set(16717636);
greenMaterial.color.set(7798531);
blueMaterial.color.set(2697513);
...
class RingParams {
  ...
  itemAngle;
  radius;
  constructor(h2, w, requredDiameter, material) {
    this.h = h2;
    this.w = w;
    this.requredDiameter = requredDiameter;
    this.material = material;
...
function init() {
  ...
  controls.update();
  stats = new stats_module_default;
